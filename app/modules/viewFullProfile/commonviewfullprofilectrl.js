                            ...
                            case 1:
                                ...
                                if (scope.lblpaid === "UnPaid" || scope.lblpaid === "Renual") {
                                    scope.modalbodyID1 = scope.lblpaid === "UnPaid" ?
                                        ...
                                        " For further assistance feel free to contact your relationship manager " + scope.aboutmyself[0].RelationShipManager + ":" + scope.personalinfo[0].ContactDetails : "Your memebership points got exhausted so please do the payment to upgrade points." +
                                        " For further assistance feel free to contact your relationship manager " + scope.aboutmyself[0].RelationShipManager + ":" + scope.personalinfo[0].ContactDetails;
                                    alerts.dynamicpopup("TabClosePopup.html", scope, uibModal);
                                } else {
