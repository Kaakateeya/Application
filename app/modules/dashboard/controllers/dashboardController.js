app.controller('Controllerpartner', ['$uibModal', '$scope', 'customerDashboardServices', 'authSvc', 'alert', function(uibModal, scope, customerDashboardServices, authSvc, alert) {
    ...
    scope.init = function() {
        // alert.open('hi', 'warning');
        // alert.open('hi', 'error');
        // alert.open('hi', 'success');
        // alert.open('hi', 'warning');
    ...
    scope.zerorecorsalert = function() {
        alert.open('Sorry No Records Found', 'warning');
    };
    scope.successfaileralert = function(msg, typewarning) {
        debugger;

        alert.open(msg, typewarning);
    };
    ...
    scope.$on('popuplogin', function(event, url, custid) {
        ...
        alert.dynamicpopup(url, scope, uibModal, custid);
    });
    scope.sendmessages = function() {
        debugger;
        scope.$broadcast('sendmsg', 'Ms', scope.messagecustid);
    }
