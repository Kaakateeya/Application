...
var app = angular.module('Kaakateeya', ['reCAPTCHA', 'ui.router', 'ngAnimate', 'ngSanitize', 'ui.bootstrap', 'angular-loading-bar', 'ngAnimate', 'ngIdle', 'ngMaterial', 'ngMessages', 'ngAria', 'KaakateeyaEdit', 'ngPassword', 'KaakateeyaRegistration']);
...
app.config(['$stateProvider', '$urlRouterProvider', 'IdleProvider', 'KeepaliveProvider', function($stateProvider, $urlRouterProvider, IdleProvider, KeepaliveProvider) {
    ...
    var states = [{ name: 'home', url: '/', ishomepage: true, isloginrequired: false, controller: 'home' },
        { name: 'dashboard', url: '/home', templateUrl: 'app/modules/dashboard/customerDashboardView.html', controller: 'Controllerpartner', isloginrequired: true },
         { name: 'dashboardnew', url: '/Dashboard', templateUrl: 'app/modules/dashboard/customerDashboardView.html', controller: 'Controllerpartner', isloginrequired: true },
        ...
        { name: 'profilidsrch', url: '/profilidsrch', templateUrl: 'app/modules/search/profileidSearch.html', controller: 'profileidsrch', isloginrequired: false },
        { name: 'savedsearch', url: '/savedsearch', templateUrl: 'app/modules/search/savedsearch.html', controller: 'savedsearchCtrl', isloginrequired: false },
        ...
        { name: 'missingfields', url: '/missingfields', templateUrl: 'app/modules/missingfieldspage/missingfields.html', controller: "missingfieldsctrl", isloginrequired: false }
    ];
