...
$(document).ready(function () {
    ...
    (function (bootstro, $, undefined) {
        ...
        function add_nav_btn(content, i) {
            ...
            content = content + '<div class="bootstro-finish-btn-wrapper"></div>';
            return content;
        }
        ...
        get_popup = function (i) {
            ...
            p.template = '<div class="popover" style="' + style + '"><div class="arrow"></div><div class="popover-inner"><button type="button" class="close" onclick="return closepopoverdiv();" style="color:#000;">&times;</button><h3 class="popover-title" style="color: #831515;background-color: #C6C1C1;"></h3> <div class="popover-content" style="color: #594D4D;"><p></p></div></div>' +
             '</div>';
...
function closepopoverdiv() {
    $('.popover ').hide();
    $('.bootstro').removeClass('bootstro-highlight');
    $(".bootstro-backdrop").remove();
    //$(".bootstro-highlight").remove();
    return false;
}