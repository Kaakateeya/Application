...
var bothsidelstmail = [],
    bothsidetext = [];
var empid, Getempid, pagenum = 0, PageSize, Fromdate, Todate, SPname, strSpname = 'Usp_Select_BothSideOneSideInterst', stremp, strBranch, datainputd, spflag, servicecustid, Viewedcontactsflag, closeflag;
var currentslide, Managementid, Empwaitingflag;
//Managementid = getmanagementid(), Empwaitingflag;
$(function () {
...
+ "    <input type='button' id='btnbothside' class='btn btn-success buttoncls bootstro' value='Bothside Intrst' onclick='return botheOneClick(" + 'btnbothside' + "," + 'btnoneside' + "," + 'btncustreplylast' + "," + 'btnviewcontacts' + "," + 'btnCloseTckt' + "," + 'btnNotvwd' + "," + 'btnall' + "," + '0' + "," + false + "," + false + ");'>"
+ "    <input id='btnoneside' class='btn btn-default buttoncls bootstro' value='Oneside Intrst' onclick='return botheOneClick(" + 'btnoneside' + "," + 'btnbothside' + "," + 'btncustreplylast' + "," + 'btnviewcontacts' + "," + 'btnCloseTckt' + "," + 'btnNotvwd' + "," + 'btnall' + "," + '1' + "," + false + "," + false + ");' type='button'>"
+ "    <input style='display: none;' id='btnviewcontacts' class='btn btn-default buttoncls' value='viewed Contacts' onclick='return botheOneClick(this, 'btnoneside', 'btnbothside', 'btncustreplylast', 'btnCloseTckt', 'btnNotvwd','btnall', '0', false);' type='button'>"
+ "    <input id='btnCloseTckt'  class='btn btn-default buttoncls bootstro' value='Close Tckt' onclick='return botheOneClick(" + 'btnCloseTckt' + "," + 'btnoneside' + "," + 'btnbothside' + "," + 'btncustreplylast' + "," + 'btnviewcontacts' + "," + 'btnNotvwd' + "," + 'btnall' + "," + '0' + "," + true + "," + false + ");' type='button'>"
+ "    <input  id='btnNotvwd'  class='btn btn-default buttoncls' value='Not viewed' onclick='return botheOneClick(" + 'btnNotvwd' + ", " + 'btnoneside' + ",  " + 'btnbothside' + ",  " + 'btncustreplylast' + "," + 'btnviewcontacts' + ", " + 'btnCloseTckt' + "," + 'btnall' + "," + '2' + "," + false + "," + false + ");' type='button'>"
+ "    <input  id='btnall'  class='btn btn-default buttoncls' value='All' onclick='return botheOneClick(" + 'btnall' + ", " + 'btnoneside' + ",  " + 'btnbothside' + ",  " + 'btncustreplylast' + "," + 'btnviewcontacts' + ", " + 'btnCloseTckt' + "," + 'btnNotvwd' + "," + '3' + "," + false + "," + false + ");' type='button'>"
+ "    <input id='btncustreplylast' class='btn btn-default buttoncls'  value='Waiting For Reply' onclick='return botheOneClick(" + 'btncustreplylast' + ", " + 'btnoneside' + ", " + 'btnbothside' + "," + 'btnviewcontacts' + ", " + 'btnCloseTckt' + ", " + 'btnNotvwd' + "," + 'btnall' + "," + '0' + ", " + false + "," + true + ");' type='button'>"
+ "</div>"
+ "</div>"
...
function bindbothOneSlideshow(loginEmpid) {
    ...
    var objd = {
        ...
        api: 'Getbothsideinterst_NewSrtucture',
        EmpId: empidObj,
...
function botheOneClick(CurrentButton, firstbtn, secondbutton, thirdbutton, fourthbtn, fithbtn, sixthbtn, flag, flagClose, flagEmpwaiting) {
    flagserves = "";
    ...
    $('#' + firstbtn.id).removeAttr('class').addClass(defaultclass);
    $('#' + secondbutton.id).removeAttr('class').addClass(defaultclass);
    $('#' + thirdbutton.id).removeAttr('class').addClass(defaultclass);
    $('#' + fourthbtn.id).removeAttr('class').addClass(defaultclass);
    $('#' + fithbtn.id).removeAttr('class').addClass(defaultclass);
    $('#' + sixthbtn.id).removeAttr('class').addClass(defaultclass);
